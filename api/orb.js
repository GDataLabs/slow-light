...
module.exports = async (req, res) => {
  ...
  const openingImagery = body.visualEnabled === true && stage === "scene_intro"
    ? findImagery(clip(person.initialWords, 300), clip(person.rawAnswer, 300)) : null;
  const ctx = {
    stage,
    ...
    openingVariation: body.visualEnabled === true && stage === "scene_intro" && !openingImagery ? {
      ...
      focus: ["layered natural textures", "a distinctive geological form", "delicate botanical detail", "the meeting of two natural materials"][randomInt(4)]
    } : null,
